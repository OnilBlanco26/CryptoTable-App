...
const HighLowIndicator = ({ current, high, low }) => {
          ...
          <div className="flex items-center justify-between w-full h-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2">
              <div className="flex w-full items-center ">
                ...
                <span className="text-sm py-0.5 px-2.5 ml-2 bg-orange text-orange bg-opacity-25 rounded uppercase ">
                  {data.symbol}
                </span>
              </div>
              ...
              <div className="flex w-full mt-4 justify-between ">
                ...
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100">
                    Valoración completamente diluida
                  </span>
                  <h2 className="text-base font-bold">
                    {" "}
                    {new Intl.NumberFormat("EN-IN", {
              ...
              <div className="flex w-full mt-4 justify-between">
                <HighLowIndicator
                  current={data.market_data.current_price[currency]}
