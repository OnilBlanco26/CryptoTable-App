  ...
  return (
    <>
                  ...
                  >
                    <td className="py-4 flex items-center uppercase">
                      <button className="outline-0 border-0 bg-none cursor-pointer">
                        <svg
                          className="w-[1.5rem] ml-1.5 fill-gray-100 hover:fill-orange"
                          width="30"
                          height="30"
                          viewBox="0 0 30 30"
                          fill="orange"
      ...
      <div className="flex items-center justify-between mt-4 capitalize h-[2rem]">
        <span>Datos proporcionados por <a className="text-orange" href="http://www.coingeck.com" target={"__blank"}>CoinGecko</a></span>
        <Pagination />
      </div>
    </>
  );
