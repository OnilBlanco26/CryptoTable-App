...
const SaveBtn = ({data}) => {
  ...
  return (
    ...
    <svg
      className={`w-[1.5rem] ml-1.5 ${allCoins.includes(data.id) ? 'fill-orange' : 'fill-gray-100'} hover:fill-orange`}
      width="30"
      height="30"
      viewBox="0 0 30 30"
      fill="orange"
      ...
      <div className="w-full min-h-[60vh] py-8 border border-gray-100 rounded">
        {
         savedData ?
          ...
          <h1 className="min-h-[60vh] text-lg text-orange flex items-center justify-center">¡No hay datos para mostrar!</h1>
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            className="w-full h-full fill-orange"
          >
            <path
